...
echo "0 Van" >> "${OUTPUT_DIR}/labels.txt"
echo "1 Truck" >> "${OUTPUT_DIR}/labels.txt"
echo "2 Pedestrian" >> "${OUTPUT_DIR}/labels.txt"
echo "3 Motorcycle" >> "${OUTPUT_DIR}/labels.txt"
echo "4 FireTruck" >> "${OUTPUT_DIR}/labels.txt"
echo "5 eScooter" >> "${OUTPUT_DIR}/labels.txt"
echo "6 Crosswalk" >> "${OUTPUT_DIR}/labels.txt"
echo "7 Car" >> "${OUTPUT_DIR}/labels.txt"
echo "8 Bus" >> "${OUTPUT_DIR}/labels.txt"
echo "9 BurningVehicle" >> "${OUTPUT_DIR}/labels.txt"
echo "10 Bicycle" >> "${OUTPUT_DIR}/labels.txt"
echo "11 Accident" >> "${OUTPUT_DIR}/labels.txt"
echo "12 VehicleUrgency" >> "${OUTPUT_DIR}/labels.txt"
